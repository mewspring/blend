// NOTE: this file has been automatically generated by blendef for Blender v277.
...
// SDNA index: 23
type GPUFXSettings struct {
	Dof     Pointer // *GPUDOFSettings
	Ssao    Pointer // *GPUSSAOSettings
	Fx_flag int8
	Pad     [7]int8
}
...
type ParticleSystemModifierData struct {
	...
	Dm_final    Pointer // *DerivedMesh
	Dm_deformed Pointer // *DerivedMesh
	Totdmvert   int32
	Totdmedge   int32
	Totdmface   int32
	Flag        int16
...
type CorrectiveSmoothModifierData struct {
	...
	Pad             [2]int8
	Defgrp_name     [64]int8
	Delta_cache     func() float32
	Delta_cache_num int32
	Pad2            [4]int8
}
...
type DataTransferModifierData struct {
	...
	Pad_i1            int32
	Layers_select_src [4]int32
	Layers_select_dst [4]int32
	Mix_mode          int32
	Mix_factor        float32
	Defgrp_name       [64]int8
	Flags             int32
...
type RenderData struct {
	...
	Engine                    [32]int8
	Bake                      BakeData
	Preview_start_resolution  int32
	Debug_pass_type           int16
	Pad                       int16
	Views                     ListBase
	Actview                   int16
	Views_format              int16
...
// SDNA index: 189
type GP_BrushEdit_Settings struct {
	Brush       [10]GP_EditBrush_Data
	Paintcursor Pointer // *struct{}
	Brushtype   int32
	Flag        int32
}
...
type ToolSettings struct {
	...
	Gpencil_seq_align                       int8
	Gpencil_ima_align                       int8
...
// SDNA index: 215
type FSMenuEntry struct {
	Next  Pointer // *FSMenuEntry
	Path  Pointer // *int8
	Name  [256]int8
	Save  int16
	Valid int16
...
type AssetUUID struct {
	Uuid_asset    [4]int32
	Uuid_variant  [4]int32
	Uuid_revision [4]int32
}

// SDNA index: 217
type AssetUUIDList struct {
	Uuids     Pointer // *AssetUUID
	Nbr_uuids int32
	Pad       int32
}

// SDNA index: 218
type FileDirEntryRevision struct {
	Next     Pointer // *FileDirEntryRevision
	Prev     Pointer // *FileDirEntryRevision
	Comment  Pointer // *int8
	Pad      Pointer // *struct{}
	Uuid     [4]int32
	Size     uint64
	Time     int64
...
// SDNA index: 219
type FileDirEntryVariant struct {
	Next          Pointer // *FileDirEntryVariant
	Prev          Pointer // *FileDirEntryVariant
	Uuid          [4]int32
	Name          Pointer // *int8
...
type FileDirEntry struct {
	Next         Pointer // *FileDirEntry
	Prev         Pointer // *FileDirEntry
	Uuid         [4]int32
	Name         Pointer // *int8
	Description  Pointer // *int8
	Entry        Pointer // *FileDirEntryRevision
	Typeflag     int32
	Blentype     int32
	Relpath      Pointer // *int8
	Poin         Pointer // *struct{}
	Image        Pointer // *ImBuf
	Tags         Pointer // **int8
	Nbr_tags     int32
...
// SDNA index: 221
type FileDirEntryArr struct {
	Entries              ListBase
	Nbr_entries          int32
	Nbr_entries_filtered int32
	Entry_idx_start      int32
	Entry_idx_end        int32
	Root                 [1024]int8
}
...
type SpaceNode struct {
	...
	Pad4           int8
	Linkdrag       ListBase
	Iofsd          Pointer // *NodeInsertOfsData
	Gpd            Pointer // *BGPdata
}
...
// SDNA index: 331
type BMouseActuator struct {
	Type        int16
	Flag        int16
	Object_axis [2]int32
	Threshold   [2]float32
	Sensitivity [2]float32
	Limit_x     [2]float32
	Limit_y     [2]float32
}
...
type Brush struct {
	...
	Gradient_stroke_mode   int32
	Gradient_fill_mode     int32
	Sculpt_tool            int8
...
type ParticleSystem struct {
	...
	Vg_neg              int16
	Rt3                 int16
	Renderdata          Pointer // *ParticleRenderData
	Pointcache          Pointer // *PointCache
	Ptcaches            ListBase
...
type WmWindow struct {
	...
	Pad             [3]int16
	Winid           int32
	Lock_pie_event  int16
	Last_pie_event  int16
...
type ParticleRenderData struct{}
type KDTree struct{}
